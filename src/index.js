  ...
  render() {
    ...
    return (
        <div>
          <div>
            <label>Email</label>
            <input type="email" onChange={ ({ target }) => this.setState({ email: target.value }) } required></input>
          </div>
          <div>
            <label>Password</label>
            <input type="password" onChange={ ({ target }) => this.setState({ password: target.value }) } required></input>
          </div>
